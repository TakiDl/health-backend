...
// app.get('/recipes', async (req, res) => {
//     try {
//         // 🌟 FIX: We tell the database to NEVER return System Logs in the master lists!
...
//         const quickRecipe = new Recipe({
//             // Removed the "(100g)" text so it looks cleaner in the Daily Menu UI
//             name: `${product['Product Name'] || product.Brand || 'Product'}`,
//             category: catMap[mealType] || 'Snack',
//             preparation_time: "0m",
//             difficulty: "Raw",
//             servings: 1,
//             isSystemLog: true, // 🌟 FIX: We tag this as a ghost log so it stays hidden from Admins!
//             ingredients: [{
//                 product: productId,
//                 amount: `${amount}g`
//             }]
...
//         // 🌟 FIX: Expert portal now fetches the fully populated meals so "Loading..." disappears instantly!
...
//     try {
//         const days = ['monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday'];
//         const mealCategories = ['breakfast', 'lunch', 'dinner', 'snacks']; // 🌟 FIXED: Changed name from meals to mealCategories
//         let populates = [];
...
//         const patientMeals = patient.recommended_meals; // 🌟 FIXED: Changed name to patientMeals to avoid conflict
//         if (patientMeals) {
...
//             recommended_meals: patient.recommended_meals || { breakfast: [], lunch: [], dinner: [], snacks: [] },
//             weekly_plan: patient.weekly_plan || {} // 🌟 Added so the frontend actually receives the 7-day plan!
//         };
...
//     try {
//         const patients = await Patient.find({}, 'plan createdAt');
...
//                     dinner: patient.weekly_plan[currentDay].dinner || [],
//                     snacks: patient.weekly_plan[currentDay].snacks || []
//                 };
//             } else {
//                 // 🌟 FREE/PLUS USERS: Start the day with an empty log
//                 resetData["recommended_meals.breakfast"] = [];
//                 resetData["recommended_meals.lunch"] = [];
//                 resetData["recommended_meals.dinner"] = [];
//                 resetData["recommended_meals.snacks"] = [];
...
//         // 🌟 EXTRACT DAILY_BUDGET FROM REQUEST
//         const { name, age, weight, height, gender, activity, daily_budget } = req.body;
...
//             gender: patient.gender,
//             activity: patient.activity,
//             daily_budget: patient.daily_budget // 🌟 RETURN IT TO FRONTEND
//         });
//     } catch (error) {
//         console.error("Profile Edit Error:", error);
//         res.status(500).json({ message: "Server error updating profile." });
